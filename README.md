...
> 📜 초기 버전 문서: [docs/README-v1.md](docs/README-v1.md) — AFTER_COMMIT 발행, 3-상태, Long PK 시절의 설계와 고민이 담겨 있다.
...
![알림 발송 시스템 아키텍처 v2](docs/architecture-v2.svg)

**상태 머신** — 각 상태가 언제, 누구에 의해 변경되는지가 설계의 핵심이다:

![알림 상태 머신](docs/state-machine.svg)
...
![1차 부하 테스트 TPS 추이](docs/perf-run1-tps.svg)
...
![2차 부하 테스트 TPS 추이](docs/perf-run2-tps.svg)
...
![3차 부하 테스트 TPS 추이](docs/perf-run3-tps.svg)
